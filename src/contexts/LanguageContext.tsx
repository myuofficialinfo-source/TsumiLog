...
const translations: Record<Language, Record<string, string>> = {
  ja: {
    ...
    'ai.recommend.description': 'あなたの好みを分析して、積みゲーとWLの中からおすすめを提案します',
  ...
  en: {
    ...
    'ai.recommend.description': 'Analyze your preferences and suggest games from your backlog and wishlist',
